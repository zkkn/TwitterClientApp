...
struct TweetRepository: TweetRepositoryType {
    ...
    func createTweet(status: String, inReplyToStatus: Int? = nil, mediaFlag: Bool? = nil, latitude: Float? = nil, longtitude: Float? = nil, placeID: Int? = nil, displayCoordinates: Bool? = nil, trimUser: Bool? = false, mediaIDs: [Int]? = nil)
        -> Observable<Tweet> {
        return apiDatastore
            .createTweet(
                status: status,
    ...
    func likeTweet(tweetID: Int, includeEntities: Bool? = nil)
        -> Observable<Tweet> {
        return apiDatastore
            .likeTweet(
                tweetID: tweetID,
